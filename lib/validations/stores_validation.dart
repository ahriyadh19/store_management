...
class StoresValidation {
  static Response? validateRead(Request request) {
    ...
    return ValidationUtils.validateRequiredInt(request, 'id', 'Store id is required');
  }
  ...
  static Response? _validateCreateOrUpdate(Request request, {required bool requireId}) {
    ...
    if (requireId) {
      final idError = ValidationUtils.validateRequiredInt(request, 'id', 'Store id is required');
      if (idError != null) {
        return idError;
      }
    }
    ...
    final descriptionError = ValidationUtils.validateRequiredString(request, 'description', 'Store description is required');
    if (descriptionError != null) {
      return descriptionError;
    }

    final addressError = ValidationUtils.validateRequiredString(request, 'address', 'Store address is required');
    if (addressError != null) {
      return addressError;
    }

    final phoneError = ValidationUtils.validateRequiredString(request, 'phone', 'Store phone is required');
    if (phoneError != null) {
      return phoneError;
    }

    return ValidationUtils.validateEmail(request);
  }
}
