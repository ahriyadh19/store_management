...
class BranchProduct {
	...
	factory BranchProduct.fromMap(Map<String, dynamic> map) {
		return BranchProduct(
			...
			reservedQuantity: ModelParsing.intOrNull(map['reservedQuantity']) ?? 0,
			reorderLevel: ModelParsing.intOrNull(map['reorderLevel']),
			lastMovementAt: ModelParsing.dateTimeOrNullFromMillisecondsSinceEpoch(map['lastMovementAt'] ?? map['last_movement_at']),
