...
class RolePermission {
  ...
  factory RolePermission.fromJson(String source) => RolePermission.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant RolePermission other) {
