...
class StoreSupplier extends AuditedSyncModel {
  String storeUuid;
  String supplierUuid;
  ...
  factory StoreSupplier.fromJson(String source) =>
      StoreSupplier.fromMap(json.decode(source) as Map<String, dynamic>);
