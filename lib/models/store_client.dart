...
class StoreClient extends AuditedSyncModel {
  String storeUuid;
  String clientUuid;
  ...
  factory StoreClient.fromJson(String source) =>
      StoreClient.fromMap(json.decode(source) as Map<String, dynamic>);
