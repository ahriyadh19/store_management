...
class AppLocalizations {
  ...
  static final Map<String, String> _en = {
    ...
    'confirmEmailDescription': 'We sent a confirmation link to {email}. On Linux desktop the link usually opens in your browser instead of returning to the app.',
    'confirmEmailPasteHint': 'If the app does not open after you confirm, copy the final browser address and paste it here to finish confirmation.',
    ...
    'forgotPasswordDescription': 'Enter your email and we will send you a reset password link.',
    ...
    'signUpSubtitle': 'Create your account and profile for the store app.',
    'forgotPasswordAction': 'Forgot password?',
    'signInFooter': 'Use your Supabase email and password to continue.',
    'signUpFooter': 'Name, username, email, password, and confirm password are used to create your profile.',
    'language': 'Language',
    'english': 'English',
    'arabic': 'العربية',
  ...
  static final Map<String, String> _ar = {
    ...
    'confirmEmailDescription': 'أرسلنا رابط تأكيد إلى {email}. على لينكس يفتح الرابط غالبًا في المتصفح بدل الرجوع إلى التطبيق.',
    'confirmEmailPasteHint': 'إذا لم يفتح التطبيق بعد التأكيد، انسخ عنوان الصفحة النهائي من المتصفح والصقه هنا لإكمال التأكيد.',
    ...
    'signUpSubtitle': 'أنشئ حسابك وملفك الشخصي لتطبيق المتجر.',
    'forgotPasswordAction': 'نسيت كلمة المرور؟',
    'signInFooter': 'استخدم بريد Supabase الإلكتروني وكلمة المرور للمتابعة.',
    'signUpFooter': 'يتم استخدام الاسم واسم المستخدم والبريد الإلكتروني وكلمة المرور وتأكيد كلمة المرور لإنشاء ملفك الشخصي.',
    'language': 'اللغة',
    'english': 'English',
    'arabic': 'العربية',
