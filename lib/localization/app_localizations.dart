...
class AppLocalizations {
  ...
  static final Map<String, String> _en = {
    ...
    'storageOnlineOnlyDescription': 'Supabase is the single source of truth. This simplifies storage flow, but it depends on network access and can add latency on larger operations.',
    'storageLocalOnly': 'Local only',
    'storageLocalOnlyDescription': 'Keep data only on this device in SQLite. This is fastest and fully offline, but it has no cross-device sync, real-time updates, or centralized control.',
  ...
  static final Map<String, String> _ar = {
    ...
    'storageHybridDescription': 'يبقى Supabase المصدر المعتمد للمصادقة والمزامنة بينما تعمل SQLite كذاكرة محلية للوصول دون اتصال. أعطال الاتصال تضع التغييرات في قائمة مزامنة لاحقة، وهذا هو الخيار الموصى به.',
    'storageOnlineOnly': 'عبر الإنترنت فقط',
    'storageOnlineOnlyDescription': 'يكون Supabase هو المصدر الوحيد للحقيقة. هذا يبسّط مسار التخزين لكنه يعتمد على الشبكة وقد يزيد زمن الاستجابة في العمليات الكبيرة.',
    'storageLocalOnly': 'تخزين محلي',
    'storageLocalOnlyDescription': 'احتفظ بالبيانات على هذا الجهاز فقط داخل SQLite. هذا أسرع ويعمل بالكامل دون اتصال، لكنه لا يوفّر مزامنة بين الأجهزة أو تحديثات لحظية أو تحكمًا مركزيًا.',
    'connectionSupabase': 'Supabase',
    'connectionSQLite': 'SQLite (Drift)',
