...
-- Includes core schema, operating model, tenant RLS, RBAC bootstrap,
-- and the public registration gate.
...
grant execute on function public.is_public_registration_open () to anon,
authenticated,
service_role;
